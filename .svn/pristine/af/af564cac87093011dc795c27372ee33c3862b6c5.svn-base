...
finp=fopen('../data/finpsca001.dat','w','l'); %open/create file tab_var.dat
mye=1026;mgalx=192;mgalz=192;my=mye;
%mye=1025;mgalx=192;mgalz=24;my=mye;
%mye=1024;mgalx=192;mgalz=192;my=mye;
