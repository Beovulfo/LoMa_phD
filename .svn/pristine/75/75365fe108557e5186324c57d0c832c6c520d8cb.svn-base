...
! initialization of energy boxes
      ...
      evv = 0d0
      eww = 0d0
      nxmax = nhmax!this is the max of modes x we want
      !Debugging to previous IC conditioons
      !k0= (nxmax*(1.0+2.0*mgalz/mgalx)**0.5)      
      !nhmax = floor(k0)
      k0 = nxmax*alp
      write(*,*) "k0 = ", k0
      write(*,*) "nhmax = ", nhmax
