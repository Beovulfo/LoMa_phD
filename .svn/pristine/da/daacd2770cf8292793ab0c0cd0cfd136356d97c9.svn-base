...
c wave AAF
      ...
      real(realprec), public :: alp2(0:mx1),bet2(0:mz1)
...
c wkhvect AAF 
      ...
      private
      include 'ctes3D'
      real(realprec),public :: up1wk(0:mgalx+1),up2wk(0:mgalx+1),
     ...
     .                  drhowk(0:mgalx+1)
      real(doubleprec),public :: up1wk8(0:mgalx+1),up2wk8(0:mgalx+1),
     .                  up3wk8(0:mgalx+1),
     ...
     .                  drhowk8(0:mgalx+1),lapzwk8(0:mgalx+1)
      real(doubleprec),public :: hache(0:mgalx-1),zeta(0:mgalx-1)
      end module wkhvect
c-------------------------------------------------------------------
c worksp AAF
      module worksp
...
!     FUNCTIONS 
      contains
        ...
        function Temper(H,Z)
        include "ctes3D"
        real(doubleprec)::Temper
        real(doubleprec),intent(in):: H,Z
