...
!***********************************************************************!
      ...
      subroutine escrphys(u,v,w,dudy,dwdy,scal,dscal,wk,
     %                    wk1,wk1r,wk2,wk2r,wk3,wk3r,wk4,wk4r,
...
!      write(*,*)'despues',j
      ...
      call fourxz(wkT,wkT,1,1) !scal (T)

      !Save u 
      do k=1,mgalz
         do i=1,mgalx
            wk1r(i,k) = wk1r(i,k) !now wk1r keeps U phys
