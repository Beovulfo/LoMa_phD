...
!      ----------------------- Programa ------------------------      
      ...
      cflz = 0.
      cfl0 = 0.
      hyy= 0.  !will keep max of hy

      hxalp=alp*mx*0.5 !1/(Dx/2)
      hzalp=bet*mz*0.5 !1/Dz/2)
      uv0=0.
      uvL=0.
...
! keep the maximum of all (1/Dx),(1/Dy),(1/Dz) 
         hyy=max(1/minval(hy),max(hxalp,hzalp))
         hyy=2.*hyy**2./Re !viscous time inverse
! calculate the viscous Dt max denominator
! take the min Dt between adv and viscous time (max denominator)
