...
factor=0.1*ymax;%eigenvector normalized for energy 1 from -1 to 1? our
%mesh going from -ymax  to ymax
...
%clean extremes
phi1real=phi1real.*cleanext;
phi1imag=phi1imag.*cleanext;
vor1real=vor1real.*cleanext;
vor1imag=vor1imag.*cleanext;
...
c=(ymax)^2/Volum;%needs to be calculated with energy
phi2real=phi1real*0;
