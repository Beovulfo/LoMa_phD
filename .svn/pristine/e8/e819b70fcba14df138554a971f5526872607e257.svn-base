...
!      ---------------  read from file and distribute
     ...
     .   ,"my=",my
         ...
         !ntotr=4*mye*mze
         ntotr=5*2*mye0*mze !vor phi psi scal mfz x2
         if (myid.eq.0) then
           if (my.ne.mye0) then
