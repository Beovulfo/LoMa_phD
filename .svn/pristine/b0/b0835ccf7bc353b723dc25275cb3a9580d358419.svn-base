...
!                                                                  !
!******************************************************************!
      subroutine escru(vor,phi,u00,w00,myid)
...
c   ----------------------- Spectra --------------------
!aaf commenting all spectra calculations, maybe is the problem
! some buffer is replacing other    
...
!-------------------------------------------------------!      
     ...
     $            trp(0:my-1),mss(0:my-1)
      ...
      fnamesta=filstt(1:index(filstt,' ')-1)//'_'//varname//'.kk'
