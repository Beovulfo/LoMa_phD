...
c ficheros AAF
      module ficheros
      implicit none
      integer :: iinp,iout,id22,isn,ispf,ista,iswap,vtkflag
      character(100) :: filinp,filout,filstt,filswap,extensiones(12)
...
c fis AAF
      ...
      private
      include 'ctes3D'
      real(4), public :: Re,alp,bet,a0
      real(8), public ::  y(my),hy(my),
     .                    fmap(my),trp(my),mss(my),rhocrit,
     .                    Prandtl,peclet,sigma
      real(4), public ::  xvec(mgalx),zvec(mgalz)
      real(4), public ::  lengthx, lengthz
      end module fis
...
!c-------------------------------------------------------------------
     ...
     .                  mum(my),Zm(my),Hm(my),Zp(my),Hp(my)
      real(8), public:: wkstats(my,23) !working var
