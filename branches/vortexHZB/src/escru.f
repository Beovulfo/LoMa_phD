...
c    ----------------------- Statistics ----------------------         
     ...
     .                    plsav(i),MPI_COMM_WORLD,ierr)
            ...
            call MPI_SEND(mfz(0,0,i),leng,MPI_REAL,plsav(i),
     .                    plsav(i),MPI_COMM_WORLD,ierr)
         enddo
         return
      else
     ...
     .                 MPI_any_tag,MPI_COMM_WORLD,istat,ierr)
            ...
            call MPI_RECV(mfz(0,0,i),leng,MPI_REAL,plcalc(i),
     .                 MPI_any_tag,MPI_COMM_WORLD,istat,ierr)
         enddo
      endif
...
!         !! master write its fields
     ...
     .                   scal(j,k,i),mfz(j,k,i),j=0,2*my-1),k=0,mz1)
         enddo
     ...
     .            iproc,iproc,MPI_COMM_WORLD,istat,ierr)            
            ...
            call MPI_RECV(mfz(0,0,1),leng,MPI_REAL,
     .            iproc,iproc,MPI_COMM_WORLD,istat,ierr)            
     ...
     .                 numerop,myid,MPI_COMM_WORLD,ierr)
         ...
         call MPI_SEND(mfz(0,0,pb),leng,MPI_REAL,
     .                 numerop,myid,MPI_COMM_WORLD,ierr)
...
!spectra
     ...
     .              wkstats(j,1),wkstats(j, 2),!up,vp
     .              wkstats(j,3),wkstats(j, 4),!wp,uvr
     .              wkstats(j,5),wkstats(j, 6),!uwr,vwr
     .              wkstats(j,7),wkstats(j, 8),!w1p,w2p
     .              wkstats(j,9),wkstats(j,10),!w3p,Tp
     .              wkstats(j,11),!ep
     .              wkstats(j,12)*fac,!ruu
     .              wkstats(j,13)*fac,wkstats(j,14)*fac,!ruv,ruw
     .              wkstats(j,15)*fac,wkstats(j,16)*fac,!rvv,rvw
     .              wkstats(j,17)*fac,wkstats(j,18)*fac,!rww,rhom
     .              wkstats(j,19)*fac,wkstats(j,20)*fac, !thep,theup
     .              wkstats(j,21),wkstats(j,22),!Hp,Zp
