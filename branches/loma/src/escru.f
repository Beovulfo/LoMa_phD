...
!spectra
     ...
     .                      MPI_SUM,MPI_COMM_CALC,ierr)
         call MPI_ALLREDUCE(mum,wkstats(1,21),my,MPI_DOUBLE_PRECISION,
     .                      MPI_SUM,MPI_COMM_CALC,ierr)
         call MPI_ALLREDUCE(num,wkstats(1,22),my,MPI_DOUBLE_PRECISION,
     .                      MPI_SUM,MPI_COMM_CALC,ierr)
     ...
     .              Tm(j),
     .              w1m(j),w2m(j),w3m(j),
     ,              them(j), !added for compressibility
     ...
     .              wkstats(j,21)*fac,wkstats(j,22)*fac, !mum and num
     .                                             j=1,my)
         close(isn)
      endif
c   ----------------------- Spectra --------------------
