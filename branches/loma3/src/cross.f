...
!======================================================!
     ...
     .       tau23(0,0,i),tau13(0,0,i),tau12(0,0,i),chwk(0,0,i),
     .       uner,sp(0,1,1,i),i)
          enddo
...
!! dm will keep the momentum thickness
              !dm =int(1/4-(um/Du)**2)
       if (istati.eq.1.and.myid.eq.0.and.rkstep.eq.1) then
              dm=0d0
              do j=1,my-2
...
!-------------(7a) Obtain tauij(1/2)----------------------------!       
          ...
          do i=pb,pe
                ...
                call deryyr2(mywk(0,0,i),tnext(0,0,i),mz)
          enddo
          do i=pb,pe
             do k=0,mz1
                do j=0,my1
...
!         taui2 = taui2A - taui2B
          do i=pb,pe
             do k=0,mz1
                do j=0,my1
                  tnext(j,k,i) =xbet(k)*(-ten12(j,k,i)-tau12(j,k,i))+
...
!          OBTAIN TAU12 and TAU13 
     ...
     .                +xbet(k)*mywk(j,k,i)-tau23(j,k,i)
          ...
          !AUX1=d(AUX1)/dy
          do i=pb,pe
               call deryr2(tnext(0,0,i),mxwk(0,0,i),mz)
          enddo
!----------------------00 MODES-------------------------------------!
...
!            1/pe*T**(sigma+1)*lap(T)
         ...
         do i=0,mgalx-1
             ...
             drhowk8(i) = drhowk8(i) + dtgamma*rhst(i,j) !DT** 
         enddo
...
!            drhowk(i)=1d0/tnextwk8(i)-1d0/rhstwk8(i)
             drhowk(i) = -drhowk8(i)/(rhstwk8(i)*tnextwk8(i))
         enddo
...
!         !Calculate u,v,w
         do i=0,mgalx-1
            up1wk(i)= up1wk8(i)*rhstwk8(i) !u for wk 
            up2wk(i)= up2wk8(i)*rhstwk8(i) !v
            up3wk(i)= up3wk8(i)*rhstwk8(i) !w for wk
         enddo
