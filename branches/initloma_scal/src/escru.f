...
c    ------------------------  Program      -----------------
     ...
     .                   scal(j,k,i),j=0,2*my-1),k=0,mz1)
      ...
      subroutine escru_reactml(vor,phi,psi,scal,mfz,u00,w00,v00,myid)
      use tem
      use fis
      use ficheros
      use point
...
c    ------------------------  Program      -----------------
      ...
      fnameima=filout(1:index(filout,' ')-1)//'hz'
