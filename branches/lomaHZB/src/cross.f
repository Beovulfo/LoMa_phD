...
!Setting BC'S
         ...
         do i=pb,pe
            ...
            enddo
         enddo
         !Trying to free these because we are imposing
         !BC through LAPPSI
         !BC on H,Z
         do i=pb,pe
            do k=0,mz1
...
!.............................................................!
!        Prepare d(psi)/dy 
!       d(psi)/dy is know from lap(psi) solver
!          do i=pb,pe
...
!                 C) BC Acoustic Condition pbot=ptop
                  ...
                  !May 22nd adding the previous rhov
                  !rhov = int(DT/(T(i)*T(i-1))/Dtbeta+
                  v00wk(j) = rf0v(j) + 0.5d0*trapz
...
!         !Calculate the cross products rhou_i*u_j
         ...
         !tauijB=s*T^s*(rhou_i*dT/dxj+rhou_j*dT/dxi)
           ...
           !ten12wk8 <= dTdx,ten13wk8 <= dTdy, ten23wk8 <= dTdz
           !tau11B
