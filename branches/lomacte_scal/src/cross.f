         ...
         do i=pb,pe
           do k=0,mz1
             do j=0,my1
               ...
               phi(j,k,i) = phi(j,k,i) +ten13(j,k,i)*dtxi!PHI
...
!   drho : T
!*******************************************************************!
!For constant density,rhou_i=u_i, no need to fourier back
         do i=pb,pe
            do k=0,mz1
               do j=0,my1
                  chwk2(j,k,i)=mxwk(j,k,i) !u
                  chwk3(j,k,i)=mywk(j,k,i) !v
                  drho(j,k,i)=mzwk(j,k,i) !w
               enddo
            enddo
         enddo
...
!For constant density,rhou_i=u_i, no need to fourier back
         do i=pb,pe
            do k=0,mz1
               do j=0,my1
                  mxwk(j,k,i)=chwk2(j,k,i)!u
                  mywk(j,k,i)=chwk3(j,k,i)!v
                  mzwk(j,k,i)=drho(j,k,i) !w
               enddo
            enddo
         enddo
...
!hyy=2.0/Re*(max(hyy,max(hxalp/2.0,hzbet/2.0)))**2.0
      hyy=2.0d0/Re*
