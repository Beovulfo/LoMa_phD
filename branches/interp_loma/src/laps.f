...
c ---------------Variables------------------------------------------- 
      integer i,j
      real(realprec),dimension(2,my) :: phi,v,dvdy
      real(8) :: rK
      real(realprec) :: zero
...
!                                                                       !
!!!***********************************************************************!
!      subroutine psiupdate(phi,drho,v,rK,dtbeta,alpr,betr)
!      use fis
!      use worksp
!      use matrices
!      use rkcoef
...
!c ---------------Variables------------------------------------------- 
!      integer i,j
!      real(4),dimension(2,my) :: phi,drho,v,dvdy
!      real(8) :: rK,dtbeta,alpr,betr
!      real(4) :: zero
!
!c ----------------------- Programa ---------------------------
!      
...
!
!      do j=1,my
!         dphi1(j)=drho(1,j)/dtbeta
!         dphi2(j)=drho(2,j)/dtbeta
!      enddo
!
!      fwk1(1) = zero
!      fwk2(1) = zero
