...
c fis AAF
      ...
      private
      include 'ctes3D'
      real(8), public ::  Re,alp,bet,a0,creal,cimag,y(my),hy(my),
     .                    fmap(my),trp(my),mss(my),A1,A2,phi1
      complex(8), public ::  ccomplex
      end module fis
c-------------------------------------------------------------------
!MPI_GROUPS aaf
      module MPI_GROUPS
...
!c-------------------------------------------------------------------
      ...
      real(8),public :: dH0dy(my), dZ0dy(my)
      real(8),public :: vpp(my), vppi(my)
      real(8),public :: dvdyr(my),dvdyi(my), drhodyr(my)
      complex(8),public :: upC(my),vpC(my),hpC(my),zpC(my)
      end module base
!c-------------------------------------------------------------------
...
c fis AAF
      ...
      real(8), public ::  cteintT
      integer, public :: pflag
!     FUNCTIONS 
      contains
        function dTdZ(Z)
        real(8),intent(in):: Z
