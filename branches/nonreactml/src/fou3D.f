...
!***********************************************************************!
        ...
        real(realprec) :: phys(mgalx+2)
        real(realprec) :: phys8(mgalx+2)
...
!     ---------------------------------------------------------
      ...
      complex(realprec):: fieldyz(0:my-1,0:mgalz-1,pb:pe) ! 0:mz1
      complex(realprec):: fieldzy(0:mgalz-1,0:my-1 ,pb:pe)
      complex(realprec):: chwk(0:mz-1,0:my-1)
      
      complex(realprec) :: zero 
...
!     ---------------------------------------------------------
      ...
      complex(realprec) :: fieldyz(0:my-1,0:mgalz-1,pb:pe)   ! 
      complex(realprec) :: fieldzy(0:mgalz-1,0:my-1,pb:pe)   !
      complex(realprec) :: chwk(0:mz-1,0:my-1)
