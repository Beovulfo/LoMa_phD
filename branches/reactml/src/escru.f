...
c  ------------------------- Variables ----------------------------
      ...
      real(realprec) :: vor(0:(2*my-1),0:mz-1,pb:pe),
     .        phi(0:(2*my-1),0:mz-1,pb:pe),
     .        psi(0:(2*my-1),0:mz-1,pb:pe),
     .        scal(0:(2*my-1),0:mz-1,pb:pe),
     .        mfz(0:(2*my-1),0:mz-1,pb:pe)
      real(4) :: re4plane(0:(2*my-1),0:mz-1)

      real(realprec) ::  u00(my),w00(my),v00(my)
      real(4) ::  wk00(3*my)
...
!         !! master write its fields
     ...
     .                   real(mfz(j,k,i),4),j=0,2*my-1),k=0,mz1)
         enddo
