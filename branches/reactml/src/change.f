...
c     ----------------------- Variables -------------------------  
      ...
      complex(realprec) ::  plano(my*mgalz,pb:pe)
      complex(realprec) ::  recta(mx1+1,lb:le)
      complex(realprec) ::   wa(lb:le,1:mx1+1)
...
c     ----------------------- Programa --------------------------       
     ...
     .           MPI_DOUBLE,iproc,0,
     .           wa(lb,pbeg(iproc)+ii-pb),nsetotr,MPI_DOUBLE,iproc,0,
...
c     ----------------------- Programa -------------------------- 
     ...
     .           ,MPI_DOUBLE,iproc,0
     .           ,plano(lbeg(iproc),ii),nsetotrid,MPI_DOUBLE,iproc,0
     .           ,MPI_COMM_WORLD,istat,ierr)
            enddo
         endif
      enddo
