c-------------------------------------------------------------------
c!      module prec
c!      integer, parameter :: realprec  = 8
c!      integer, parameter :: realwrite = 4
c!      integer, parameter :: complexprec = 8
c!      end module prec
c Input parameters read from field
      module input
      implicit none
      private
      include 'ctes3D'
      real(4),public :: Ree,alpe,bete,a0e
      integer,public :: mxe,mye,mze,mym,mye0
      real(realprec),public:: ye(my),fmape(my)
      end module input
c diag AAF
      module diag
      implicit none
...
c wave AAF
      ...
      real(8), public :: alp2(0:mx1),bet2(0:mz1)
...
c wkhvect AAF 
      ...
      private
      include 'ctes3D'
      real(8),public :: up1wk(0:mgalx+1),up2wk(0:mgalx+1),
...
!     .   (dcosh( betha*(Z-Zs)))+dlog(dcosh(betha*Zs))))
     ...
     .             0.5d0*(dtanh(0.5*betha*(Z-Zsbar))+1d0)
!        dZbdZ = Zsbar/Zs+((1d0-Zsbar)/(1d0-Zs)-Zsbar/Zs)*
